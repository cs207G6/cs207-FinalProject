...
class NASACoeffs:
    ...
    def create_db(self, filename):
        ...
        lows_to_insert = (
            name, float(low_tmin), float(low_tmax), Low_C_1, Low_C_2, Low_C_3, Low_C_4, Low_C_5, Low_C_6, Low_C_7)
        ...
        high_to_insert = name, float(high_tmin), float(
            high_tmax), High_C_1, High_C_2, High_C_3, High_C_4, High_C_5, High_C_6, High_C_7
